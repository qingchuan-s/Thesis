# -*- coding: utf-8 -*-
"""
Created on Fri Apr 23 19:31:32 2021
...
def create_sim(seed,ratio):
    ...
    beta_days = ['2020-03-15','2020-04-15','2020-05-10','2020-06-22','2020-07-20','2020-08-22','2020-09-01','2020-09-22','2020-10-01','2020-10-15','2020-11-01',
                 '2020-11-20','2020-11-30','2020-12-14', '2021-01-01','2021-03-01']
    h_beta_changes = [1.10, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.10, 1.10, 1.10, 1.20, 1.30, 1.20, 1.10, 1.00]
    s_beta_changes = [0.80, 0.50, 0.50, 0.40, 0.60, 0.60, 1.00, 0.80, 0.80, 1.00, 0.80, 1.00, 1.20, 1.00, 0.80, 0.70]
    w_beta_changes = [0.80, 0.50, 0.50, 0.40, 0.60, 0.60, 1.00, 0.80, 0.80, 1.00, 0.80, 1.00, 1.20, 1.00, 0.80, 0.70]
    c_beta_changes = [0.90, 0.60, 0.50, 0.70, 0.90, 0.80, 1.00, 0.70, 0.70, 1.00, 0.80, 1.10, 1.30, 1.10, 1.00, 0.80]
    ...
    clip_days = ['2020-03-15','2020-04-15','2020-05-10','2020-06-08','2020-06-22','2020-08-17','2020-09-01','2020-09-15','2020-10-05',
                 '2020-11-05','2020-11-20','2020-12-09','2020-12-19','2020-12-25','2021-01-04','2021-02-01', '2021-03-01']
    s_clip_changes = [0.01, 0.20, 0.40, 0.70, 0.05, 0.10, 0.90, 0.80, 0.70, 0.70, 0.70, 0.40, 0.05, 0.05, 0.05, 0.30, 0.50]
    w_clip_changes = [0.10, 0.30, 0.50, 0.70, 0.60, 0.80, 1.00, 0.80, 0.70, 0.70, 0.70, 0.60, 0.40, 0.10, 0.50, 0.60, 0.60]
    c_clip_changes = [0.20, 0.40, 0.60, 0.85, 1.00, 1.00, 1.00, 0.80, 0.80, 0.90, 0.90, 0.70, 0.80, 0.50, 0.60, 0.70, 0.80]
...
for seed in [2,3,4,6,8,9,10,16,20,25,27,33,37,39,43,44,50,58]:
    print(str('Sim')+ str(seed)+str('; ratio=')+str('1.4'))
    sim =  create_sim(seed=seed,ratio=1.4)
    sim.run()
    sims1.append(sim)

#%%
for seed in [2,3,4,6,8,9,10,16,20,25,27,33,37,39,43,44,50,58]:
    print(str('Sim')+ str(seed)+str('; ratio=')+str('1.5'))
    sim =  create_sim(seed=seed,ratio=1.5)
    sim.run()
    sims2.append(sim)

#%%
for seed in [2,3,4,6,8,9,10,16,20,25,27,33,37,39,43,44,50,58]:
    print(str('Sim')+ str(seed)+str('; ratio=')+str('1.6'))
    sim =  create_sim(seed=seed,ratio=1.6)
    sim.run()
    sims3.append(sim)
   
#%%    
for seed in [2,3,4,6,8,9,10,16,20,25,27,33,37,39,43,44,50,58]:
    print(str('Sim')+ str(seed)+str('; ratio=')+str('1.7'))
    sim =  create_sim(seed=seed,ratio=1.7)
    sim.run()
    sims4.append(sim)
...
msim1.reduce()
msim1.plot(to_plot=['new_infections'],  do_show=False, legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
...
msim1.plot(to_plot=['cum_infections'],  do_show=False, legend_args={'loc': 'upper left'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.title('Ratio = 1.4: Number of cumulative infections')
msim1.plot(to_plot=['r_eff'], do_save=True, do_show=False,legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axhline(1,linestyle='--', c=[0.8,0.4,0.4], alpha=1, lw=4) 
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.title('Ratio = 1.4: Effective reproduction number')

#%%
msim2 = cv.MultiSim(sims2)
msim2.reduce()
msim2.plot(to_plot=['new_infections'],  do_show=False, legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.text(sim.day('2020-12-14')+2,7600,'Introduction of B.1.1.7')
pl.title('Ratio = 1.5: Number of new infections')
msim2.plot(to_plot=['cum_infections'],  do_show=False, legend_args={'loc': 'upper left'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.title('Ratio = 1.5: Number of cumulative infections')
msim2.plot(to_plot=['r_eff'], do_save=True, do_show=False,legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axhline(1,linestyle='--', c=[0.8,0.4,0.4], alpha=1, lw=4) 
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.title('Ratio = 1.5: Effective reproduction number')

#%%
msim3 = cv.MultiSim(sims3)
msim3.reduce()
msim3.plot(to_plot=['new_infections'],  do_show=False, legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.text(sim.day('2020-12-14')+2,7600,'Introduction of B.1.1.7')
pl.title('Ratio = 1.6: Number of new infections')
msim3.plot(to_plot=['cum_infections'],  do_show=False, legend_args={'loc': 'upper left'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.title('Ratio = 1.6: Number of cumulative infections')
msim3.plot(to_plot=['r_eff'], do_save=True, do_show=False,legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axhline(1,linestyle='--', c=[0.8,0.4,0.4], alpha=1, lw=4) 
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.title('Ratio = 1.6: Effective reproduction number')
#%%
msim4 = cv.MultiSim(sims4)
msim4.reduce()
msim4.plot(to_plot=['new_infections'],  do_show=False, legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.text(sim.day('2020-12-14')+2,7600,'Introduction of B.1.1.7')
pl.title('Ratio = 1.7: Number of new infections')
msim4.plot(to_plot=['cum_infections'],  do_show=False, legend_args={'loc': 'upper left'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.title('Ratio = 1.7: Number of cumulative infections')
msim4.plot(to_plot=['r_eff'], do_save=True, do_show=False,legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axhline(1,linestyle='--', c=[0.8,0.4,0.4], alpha=1, lw=4) 
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.title('Ratio = 1.7: Effective reproduction number')

#%%
msim5 = cv.MultiSim(sims5)
msim5.reduce()
msim5.plot(to_plot=['new_infections'],  do_show=False, legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.text(sim.day('2020-12-14')+2,7600,'Introduction of B.1.1.7')
pl.title('Ratio = 1.8: Number of new infections')
msim5.plot(to_plot=['cum_infections'],  do_show=False, legend_args={'loc': 'upper left'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.title('Ratio = 1.8: Number of cumulative infections')
msim5.plot(to_plot=['r_eff'], do_save=True, do_show=False,legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axhline(1,linestyle='--', c=[0.8,0.4,0.4], alpha=1, lw=4) 
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.title('Ratio = 1.8: Effective reproduction number')

#%%
msim6 = cv.MultiSim(sims6)
msim6.reduce()
msim6.plot(to_plot=['new_infections'],  do_show=False, legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.text(sim.day('2020-12-14')+2,8800,'Introduction of B.1.1.7')
pl.title('Ratio = 1.9: Number of new infections')
msim6.plot(to_plot=['cum_infections'],  do_show=False, legend_args={'loc': 'upper left'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.title('Ratio = 1.9: Number of cumulative infections')
msim6.plot(to_plot=['r_eff'], do_save=True, do_show=False,legend_args={'loc': 'best'}, axis_args={'hspace': 0.4}, interval=50, n_cols=1)
pl.axhline(1,linestyle='--', c=[0.8,0.4,0.4], alpha=1, lw=4) 
pl.axvline(sim.day('2020-12-14'),linestyle='--') 
pl.title('Ratio = 1.9: Effective reproduction number')
