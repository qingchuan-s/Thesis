...
def create_sim():
    ...
    # Day 138: 2020-06-17
    # Day 260: 2020-10-17
    relative_death = cv.dynamic_pars(rel_death_prob=dict(days=[1,138,260], vals=[0.93,0.35,0.2]))
    ...
    c_beta_changes = [0.20, 0.30, 0.40, 0.60, 0.90, 0.90, 0.80, 0.80, 0.70, 0.60, 0.60, 0.75, 0.80, 0.85, 0.65]
    ...
    s_prob_dec = 0.1 # suppose 65% of symptimatic people will go to test
    ...
    #0.0075 means that about 10% people in this group will go to test.
    #0.0115 means that about 15% people in this group will go to test.
    #0.0158 means that about 20% people in this group will go to test.
    #0.0203 means that about 25% people in this group will go to test.
    #0.0358 means that about 40% people in this group will go to test.
    interventions += [
        ...
        cv.test_prob(symp_prob=s_prob_nov, asymp_prob=0.001, symp_quar_prob=0.0075, asymp_quar_prob=0.001, start_day=day_nov, end_day=day_dec-1, test_delay=t_delay),
        cv.test_prob(symp_prob=s_prob_dec, asymp_prob=0.0158, symp_quar_prob=0.0358, asymp_quar_prob=0.0158, start_day=day_dec, test_delay=t_delay),
